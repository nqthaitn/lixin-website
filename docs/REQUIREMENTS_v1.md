# REQUIREMENTS DOCUMENT v1 — WEBSITE LIXIN VN
> Phiên bản: v1
> Ngày tạo: 26/02/2026
> BA: Hoa (@hoa_ba_bot)
> Decision Maker: @nqthaitn ✅ APPROVED
> Khách hàng: Chị Hằng (@janengotn)
...
- ⏰ **Tự động hàng ngày**: thu thập tin tức từ các báo uy tín về kế toán & thuế
- ✍️ **Viết lại** theo văn phong của Lixin
- 🌍 **3 ngôn ngữ**: Việt - Trung - Anh
- ✅ **Admin duyệt** trước khi đăng lên website
- 📝 Admin có thể chỉnh sửa nội dung trước khi duyệt
...
| AI Agent | Tự động thu thập & tổng hợp tin tức hàng ngày |
...
## 9. TECH STACK (do Leader đề xuất)
...
| Phase 2 | Database, API, Admin Panel, AI News Agent, Logo | 🔄 Chờ triển khai |
...
- File này là **Requirement v1** — các thay đổi sau sẽ được versioning (v2, v3,...)
